...
def bivariate_skew_Gaussian_center(
        kernel_size,
        sig_x,
        sig_y,
        theta,
...
def bivariate_anisotropic_Gaussian(
        kernel_size,
        sig_x,
        sig_y,
        theta,
...
def random_bivariate_generalized_Gaussian(
    ...
    kernel = bivariate_generalized_Gaussian(kernel_size, sigma_x, sigma_y, rotation, beta)
...
def show_plateau_kernel():
    ...
    kernel_gau = bivariate_generalized_Gaussian(kernel_size, 2, 4, -math.pi / 8, 2, grid=None)
